...
class PurchaseModel extends Model{
    ...
    protected $allowedFields = ['AccountId','ProductId','paypal_order_id','paypal_transaction_id','amount','status','created_at','updated_at','complete_name','address','phone','province','city'];
